...
public class AbsensiAdapter extends BaseAdapter {
    ArrayList<ObjectAbsensi> listAbsensi;
    Activity activity;

    public AbsensiAdapter(Activity activity, ArrayList<ObjectAbsensi> listAbsensi){
        Log.d("absensi",Integer.toString(listAbsensi.size()));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ObjectAbsensi absensi = (ObjectAbsensi) getItem(position);
        holder.textPersentase.setText(absensi.getAbsensi()+"%");
        holder.textMataKuliah.setText(absensi.getMatkul());
